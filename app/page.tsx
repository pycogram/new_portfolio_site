    ...
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16">
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-muted-foreground">@ Nugenesis</div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Rust", "TypeScript", "React", "Express", "RESTFUL API", "Node.js", "NextJs", "MongoDB", "Javascript", "PHP", "mySQL"].map((skill) => (
                    <span
                      key={skill}
        ...
        <section id="work" ref={(el) => (sectionsRef.current[1] = el)} className="min-h-screen py-20 sm:py-32 opacity-0">
          <div className="space-y-12 sm:space-y-16">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              <h2 className="text-3xl sm:text-4xl font-light">Learning Journey</h2>
              <div className="text-sm text-muted-foreground font-mono">2023 — {currentYear}</div>
            </div>
            ...
            <div className="space-y-8 sm:space-y-12">
              {[
                ...
                },
                {
                  ...
                  // company: "Stripe",
                  description: "Developed a full-stack application with mining and lockup algorithms, user authentication, and a secure signup system.",
                ...
                },
                {
                  ...
                  // company: "Linear",
                  description: "Delivered high-performance, scalable, and responsive static websites tailored to client needs.",
                ...
                },
                {
                  ...
                  role: "Figma Designer",
                  // company: "Airbnb",
                  description: "Designed modern, user-friendly interfaces in Figma and translated them into functional websites.",
                  tech: ["Figma", "Canvas", "WPS"],
                }
        ...
        <section id="thoughts" ref={(el) => (sectionsRef.current[2] = el)} className="min-h-screen py-20 sm:py-32 opacity-0">
          <div className="space-y-12 sm:space-y-16">
            <h2 className="text-3xl sm:text-4xl font-light">Projects Built</h2>
              ...
              {[
                {
                  ...
                  date: "July 2025",
                  readTime: "2 months",
                  url: "https://github.com/pycogram/smartcoin_mining_app"
                },
                {
                  title: "Memecoin Website",
                  excerpt: "Created responsive and scalable websites for multiple memecoin projects, ensuring functionality and smooth performance across devices.",
                  date: "Nov 2024",
                  readTime: "48 hours",
                  url: "https://sokonsol.vercel.app"
                },
                {
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2 text-sm text-muted-foreground group-hover:text-foreground transition-colors duration-300">
                      <span><a href={post.url}>View Info</a></span>
                      <svg
          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16">
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Link
                    href="mailto:kaluifesinachi@yahoo.com"
                    className="group flex items-center gap-3 text-foreground hover:text-muted-foreground transition-colors duration-300"
                  >
                    <span className="text-base sm:text-lg">kaluifesinachi@yahoo.com</span>
                    <svg
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="text-sm text-muted-foreground font-mono">My Social handles:</div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { name: "GitHub", handle: "@pycogram", url: "https://github.com/pycogram" },
                  { name: "Twitter - X", handle: "@tm401z", url: "https://x.com/tm401z" },
                  { name: "Facebook", handle: "ifesinachi daniel", url: "https://facebook.com/share/IB9475UH3v" },
                  { name: "LinkedIn", handle: "ifesinachi daniel", url: "https://www.linkedin.com/in/ifesinachi-daniel-36bb70298" },
                ].map((social) => (
                  <Link
                    key={social.name}
                    href={social.url}
